...
module.exports = [
    body('email').notEmpty().withMessage('Tienes que ingresar un email').bail().isEmail().withMessage('Tienes que escribir un email valido'),
    body('password').notEmpty().withMessage('Tienes que ingresar un password').bail(),
